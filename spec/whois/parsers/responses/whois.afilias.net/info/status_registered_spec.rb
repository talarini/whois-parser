...
describe Whois::Parsers::WhoisAfiliasNet, "status_registered.expected" do
  ...
  subject do
    file = fixture("responses", "whois.afilias.net/info/status_registered.txt")
  ...
  describe "#updated_on" do
    it do
      ...
      expect(subject.updated_on).to eq(Time.parse("2018-06-29 09:39:25 UTC"))
    end
  end
  describe "#expires_on" do
    it do
      expect(subject.expires_on).to be_a(Time)
      expect(subject.expires_on).to eq(Time.parse("2019-07-31 23:57:50 UTC"))
    end
  end
