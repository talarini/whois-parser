...
describe Whois::Parsers::WhoisInregistryNet, "status_registered.expected" do
  ...
  describe "#updated_on" do
    it do
      expect(subject.updated_on).to eq(Time.parse("2018-01-13 10:28:18 UTC"))
    end
  end
  describe "#expires_on" do
    it do
      expect(subject.expires_on).to eq(Time.parse("2019-02-14 20:35:14 UTC"))
    end
  end
